...
function interactive_mode() {
    ...
    while true; do
        # Save the raw prompt without any color to readline, but color it for display
        PS1="rc> "  # Set the basic prompt
        # Green colored rc> prompt using ANSI escape code for display, not for input
