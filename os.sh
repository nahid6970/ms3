...
menu_items=(
    ...
    " 4:Rclone Setup:                   rclone_setup                            :$BLUE"
    " 5:Song [rs]:                      Restore_Songs                           :$BLUE"
    " 6:Neovim Setup:                   nvim_setup                              :$BLUE"
    " 7:Git Push:                       git_push_repo                           :$BLUE"
    ...
    " u:Gitasdasd Pull [ms3]:                 update_ms3_repo                         :$BLUE"
)
